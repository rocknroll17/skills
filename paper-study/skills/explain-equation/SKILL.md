...
## 블록 1 — 한 줄 비유 (Intuition first)

수식이 **결국 뭘 하려는 것**인지 일상 비유 한 문장. 기호 하나도 쓰지 말고.

예:
- Cross-entropy loss는 "정답 확률에 얼마나 자신 있게 찍었는지 벌점으로 환산하는 선생님."
- Contrastive loss는 "같은 클래스 샘플은 가깝게, 다른 클래스는 멀게 밀어내는 자석."
- L2 regularization은 "파라미터가 너무 커지면 벌금 부과."

비유 고르는 기준: 일상 경험 + 그 수식의 **주된 의도** 포착.
