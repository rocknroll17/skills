...
**문체**: 말하듯 설명하되 단어는 정확하게. 번역체(어색한 직역) 대신 자연스러운 한국어, 정착된 영어 용어는 원어 그대로. 군말은 덜어낸다.

> 분야 무관. 본문 중 예시 수식은 설명을 위한 것일 뿐, 5블록 구조는 어떤 영역의 수식에도 그대로 적용한다.
